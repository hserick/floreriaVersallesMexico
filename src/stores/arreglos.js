    ...
    lista: [
      {
        ...
        imagen: resolveAssetPath('/img/arreglos/cumple/cumple001.png'),
        categorias: ['cumple'],
        destacado: false
      },
      {
        ...
        descripcion: 'Un bouquet delicado de rosas pastel para expresar ternura y cariño.',
        imagen: resolveAssetPath('/img/arreglos/cumple/cumple002.jpg'),
        categorias: ['cumple'],
        destacado: false
      },
      {
        ...
        descripcion: 'Un bouquet delicado de rosas pastel para expresar ternura y cariño.',
        imagen: resolveAssetPath('/img/arreglos/cumple/cumple003.jpg'),
        categorias: ['cumple'],
        destacado: true
      },
      {
        ...
        descripcion: 'Un bouquet delicado de rosas pastel para expresar ternura y cariño.',
        imagen: resolveAssetPath('/img/arreglos/cumple/cumple004.jpg'),
        categorias: ['cumple'],
        destacado: false
      },
      {
        ...
        imagen: resolveAssetPath('/img/arreglos/romance/romance001.jpg'),
      ...
      },
      {
        ...
        nombre: 'Romance 002',
        descripcion: 'Flores llenas de color y luz para celebrar los momentos más felices.',
        imagen: resolveAssetPath('/img/arreglos/romance/romance002.jpg'),
        categorias: ['romance'],
        destacado: true
      },
      {
        ...
        nombre: 'Romance 003',
        descripcion: 'Flores llenas de color y luz para celebrar los momentos más felices.',
        imagen: resolveAssetPath('/img/arreglos/romance/romance003.jpg'),
        categorias: ['romance'],
        destacado: true
      },
      {
        ...
        nombre: 'Romance 004',
        descripcion: 'Flores llenas de color y luz para celebrar los momentos más felices.',
        imagen: resolveAssetPath('/img/arreglos/romance/romance004.jpg'),
        categorias: ['romance'],
        destacado: true
      },
      {
        ...
        imagen: resolveAssetPath('/img/arreglos/elegantes/elegantes001.jpg'),
      ...
      },
      {
        ...
        descripcion: 'Composición floral sobria para rendir homenaje a un ser querido.',
        imagen: resolveAssetPath('/img/arreglos/elegantes/elegantes002.jpg'),
        categorias: [ 'elegantes'],
        destacado: true
      },
      {
        ...
        descripcion: 'Composición floral sobria para rendir homenaje a un ser querido.',
        imagen: resolveAssetPath('/img/arreglos/elegantes/elegantes003.jpg'),
        categorias: [ 'elegantes'],
        destacado: true
      },
      {
        ...
        imagen: resolveAssetPath('/img/arreglos/condolencias/condolencias001.jpg'),
      ...
      },
      {
        ...
        descripcion: 'Rosas rojas intensas que capturan el corazón.',
        imagen: resolveAssetPath('/img/arreglos/condolencias/condolencias002.jpg'),
        categorias: ['condolencias'],
        destacado: true
      },
      {
        ...
        descripcion: 'Rosas rojas intensas que capturan el corazón.',
        imagen: resolveAssetPath('/img/arreglos/condolencias/condolencias003.jpg'),
        categorias: ['condolencias'],
        destacado: true
      }
